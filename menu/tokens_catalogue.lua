...
M.TOKENS = {
    ...
    { description = _("蓝牙电量"), token = "%bt_battery", chip = "device" },
    { description = _("蓝牙已连接"), token = "%bt_connected", chip = "device" },
...
M.CONDITIONALS = {
    ...
    { description = _("蓝牙已连接时"), expression = "[if:bt_connected]...[/if]", chip = "ifelse" },
    { description = _("蓝牙电量范围"), expression = "[if:bt_battery<20]...[/if]", chip = "ifelse" },
    ...
    { description = _("蓝牙已连接 + 蓝牙电量"), expression = "[if:bt_connected]%bt_connected %bt_battery[/if]", chip = "templates" },
    { description = _("翻页器已连接/未连接"), expression = "[if:bt_connected]\xE2\x9A\xA1翻页器：%bt_battery[else]未连接翻页器[/if]", chip = "templates" },
    { description = _("翻页器电量低"), expression = "[if:bt_battery<20]翻页器电量低：%bt_battery[/if]", chip = "templates" },
