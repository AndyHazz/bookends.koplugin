...
| Line editor | Symbol picker | Progress bar styles |
|:---:|:---:|:---:|
| ![Line editor](screenshots/line-editor.png) | ![Symbol picker](screenshots/icon-picker.png) | ![Progress bar styles](screenshots/progress-bars-styles.png) |
